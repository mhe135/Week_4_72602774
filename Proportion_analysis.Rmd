...
```
The percentage of votes in favour of completion of cases is around **0.6**. This indicates that **60%** of respondents cast "yes" ballots in the referendum. This percentage gives an idea of the general level of support for the referendum.
